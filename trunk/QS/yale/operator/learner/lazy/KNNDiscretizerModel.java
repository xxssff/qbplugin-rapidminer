 ...
 * 
 */
public class KNNDiscretizerModel extends PredictionModel {
	...
	private DiscretizationModel discM;
	 ...
	 */
	public KNNDiscretizerModel(ExampleSet trainingSet, SimilarityMeasure similarity, int k, boolean weightedVote, DiscretizationModel dm) {
		super(trainingSet);
	...
	public void performPrediction(ExampleSet testSet, Attribute predictedLabel) {
		for (Example e : testSet) {
			...
			//TODO: CAMBIAR LA LLAMADA PARA ENVIAR EL MODELO
