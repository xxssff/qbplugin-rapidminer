 ...
 * 
 * Creo una copia de este objeto porque en el método compareTo
 * se hacía una comparación entre los hashings de los objetos en caso
 * de que los pesos fuesen iguales. Esto hacía que los resultados
 * pudiesen variar entre una ejecución y otra pues el hash depende
 * de la posición de memoria de un objeto.
 * 
 * @author F.J. Cuberos
